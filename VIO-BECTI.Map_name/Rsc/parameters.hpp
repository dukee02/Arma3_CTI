class Params {
	...
	*/
	...
	class CTI_RESPAWN_TIMER {
		title = "RESPAWN: Delay";
		values[] = {15,20,25,30,35,40,45,50,55,60,900};
	...
	class CTI_TOWNS_ACTIVE_TIME {
		...
		*/
		//---Gamerfoo Gameplay---
		values[] = {300,600,900,1200,1500,1800,7200};
		texts[] = {"5min","10min","15min","20min","25min","30min","2 hours"};
		default = 7200; //300;
	};
	...
	class CTI_VEHICLES_EMPTY_TIMEOUT {
		...
		*/
		//---Gamerfoo Gameplay---
		values[] = {60,120,180,240,300,600,1200,1800,2400,3000,3600,14400};
		texts[] = {"1 Minute","2 Minutes","3 Minutes","4 Minutes","5 Minutes","10 Minutes","20 Minutes","30 Minutes","40 Minutes","50 Minutes","1 Hour","4 hours"};
		default = 14400; //1200;
	};
