...
autoScrollDelay = 5;
autoScrollRewind = 0;
soundSelect[] = {"\A3\Ui_f\data\Sound\CfgNotifications\addItemOK",0.09,1};
...
font = "PuristaMedium";
soundSelect[] = {"\A3\Ui_f\data\Sound\CfgNotifications\addItemOK",0.09,1};
soundExpand[] = {"\A3\Ui_f\data\Sound\CfgNotifications\addItemOK",0.09,1};
soundCollapse[] = {"\A3\Ui_f\data\Sound\CfgNotifications\addItemOK",0.09,1};
maxHistoryDelay = 1.0;
sizeEx = "( ( ( ((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
