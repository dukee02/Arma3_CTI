...
switch (true) do {
	case (_classname in (missionNamespace getVariable format ["CTI_%1_%2Units", _side, CTI_BARRACKS])): {
		switch (_action) do {
			case "buyed": {missionNamespace setVariable [format ["CTI_%1_InfBuild", _side], (missionNamespace getVariable format ["CTI_%1_InfBuild", _side]) + 1]};
			case "killed": {missionNamespace setVariable [format ["CTI_%1_InfKilled", _side], (missionNamespace getVariable format ["CTI_%1_InfKilled", _side]) + 1]};
	...
	case (_classname in (missionNamespace getVariable format ["CTI_%1_%2Units", _side, CTI_LIGHT])): {
		switch (_action) do {
			case "buyed": {missionNamespace setVariable [format ["CTI_%1_LightBuild", _side], (missionNamespace getVariable format ["CTI_%1_LightBuild", _side]) + 1]};
			case "killed": {missionNamespace setVariable [format ["CTI_%1_LightKilled", _side], (missionNamespace getVariable format ["CTI_%1_LightKilled", _side]) + 1]};
	...
	case (_classname in (missionNamespace getVariable format ["CTI_%1_%2Units", _side, CTI_HEAVY])): {
		switch (_action) do {
			case "buyed": {missionNamespace setVariable [format ["CTI_%1_HeavyBuild", _side], (missionNamespace getVariable format ["CTI_%1_HeavyBuild", _side]) + 1]};
			case "killed": {missionNamespace setVariable [format ["CTI_%1_HeavyKilled", _side], (missionNamespace getVariable format ["CTI_%1_HeavyKilled", _side]) + 1]};
	...
	case (_classname in (missionNamespace getVariable format ["CTI_%1_%2Units", _side, CTI_AIR])): {
		switch (_action) do {
			case "buyed": {missionNamespace setVariable [format ["CTI_%1_AirBuild", _side], (missionNamespace getVariable format ["CTI_%1_AirBuild", _side]) + 1]};
			case "killed": {missionNamespace setVariable [format ["CTI_%1_AirKilled", _side], (missionNamespace getVariable format ["CTI_%1_AirKilled", _side]) + 1]};
	...
	case (_classname in (missionNamespace getVariable format ["CTI_%1_%2Units", _side, CTI_DEPOT])): {
		switch (_action) do {
			case "buyed": {missionNamespace setVariable [format ["CTI_%1_SupportBuild", _side], (missionNamespace getVariable format ["CTI_%1_SupportBuild", _side]) + 1]};
			case "killed": {missionNamespace setVariable [format ["CTI_%1_SupportKilled", _side], (missionNamespace getVariable format ["CTI_%1_SupportKilled", _side]) + 1]};
	...
	case (_classname in (missionNamespace getVariable format ["CTI_%1_%2Units", _side, CTI_NAVAL])): {
		switch (_action) do {
			case "buyed": {missionNamespace setVariable [format ["CTI_%1_NavalBuild", _side], (missionNamespace getVariable format ["CTI_%1_NavalBuild", _side]) + 1]};
			case "killed": {missionNamespace setVariable [format ["CTI_%1_NavalKilled", _side], (missionNamespace getVariable format ["CTI_%1_NavalKilled", _side]) + 1]};
	...
	case (_classname in ["B_Protagonist_VR_F","O_Protagonist_VR_F"]): {
		switch (_action) do {
			case "buyed": {missionNamespace setVariable [format ["CTI_%1_PlayersBuild", _side], (missionNamespace getVariable format ["CTI_%1_PlayersBuild", _side]) + 1]};
			case "killed": {missionNamespace setVariable [format ["CTI_%1_PlayersKilled", _side], (missionNamespace getVariable format ["CTI_%1_PlayersKilled", _side]) + 1]};
	...
	default {
		switch (_action) do {
			case "buyed": {missionNamespace setVariable [format ["CTI_%1_OtherBuild", _side], (missionNamespace getVariable format ["CTI_%1_OtherBuild", _side]) + 1]};
			case "killed": {missionNamespace setVariable [format ["CTI_%1_OtherKilled", _side], (missionNamespace getVariable format ["CTI_%1_OtherKilled", _side]) + 1]};
