...
_pathmOMRMain= format["%1\outlw_magrepack\config.hpp",_modPath];
_pathmOMRKeyBind= format["%1\outlw_magrepack\config.hpp",_modPath];
_pathmOMRMisc= format["%1\outlw_magrepack\config.hpp",_modPath];

// Appel des inclusions
[] execVM _pathOMRMain;
[] execVM _pathOMRKeyBind;
[] execVM _pathOMRMisc;
...
//---------------------------------------------------------------------
//  Archives originales des chemins

[] execVM "gfoo\outlw_magrepack\Scripts\MagRepack_Main.sqf";
[] execVM "gfoo\outlw_magrepack\Scripts\MagRepack_Keybindings.sqf";
[] execVM "gfoo\outlw_magrepack\Scripts\MagRepack_Misc.sqf";
