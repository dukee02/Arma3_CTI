...
if (CTI_Log_Level >= CTI_Log_Debug) then { ["VIOC_DEBUG", "FILE: Common\Functions\Common_HasUpgrade.sqf", format ["side <%1> UGTowns <%2> Upgrades <%3>",  _side, _upgrade, _upgrades]] call CTI_CO_FNC_Log };
